      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div className="md:col-span-2">
            <span className="font-bold">lvalentina</span>
            <p className="mt-4 text-neutral-400 max-w-md">
              Servicios de marketing digital para potenciar tu negocio. Estrategias personalizadas, contenido de calidad y resultados medibles.
            </p>
            <div className="flex space-x-4 mt-6">
              <a href="https://www.instagram.com/lvalentinadg/" className="text-neutral-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-neutral-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-400 text-sm">© {currentYear} lvalentina. Todos los derechos reservados.</p>
